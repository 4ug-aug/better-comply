...
export const AuditTrailEventOutSchema = {
    properties: {
        event_type: {
            type: 'string',
            title: 'Event Type'
    ...
    type: 'object',
    required: ['event_type', 'event_id', 'timestamp', 'status', 'run_id', 'run_kind', 'artifact_ids', 'artifact_uris', 'version_id', 'parsed_uri', 'diff_uri', 'content_hash', 'error'],
    title: 'AuditTrailEventOut',
    description: 'Audit trail event response model.'
} as const;
...
export const DocumentAuditTrailResponseSchema = {
    properties: {
        document_id: {
            type: 'integer',
            title: 'Document Id'
        ...
        events: {
            items: {
                '$ref': '#/components/schemas/AuditTrailEventOut'
            },
            type: 'array',
            title: 'Events'
        }
    ...
    type: 'object',
    required: ['document_id', 'source_url', 'events'],
    title: 'DocumentAuditTrailResponse',
    description: 'Document audit trail response containing all processing events.'
} as const;
