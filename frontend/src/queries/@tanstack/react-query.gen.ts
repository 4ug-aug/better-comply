...
export const getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetQueryKey = (options: Options<GetVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetData>) => createQueryKey('getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGet', options);
 ...
 */
export const getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetOptions = (options: Options<GetVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetQueryKey(options)
    });
};
