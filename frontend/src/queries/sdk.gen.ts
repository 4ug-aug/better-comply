 ...
 *
 * Get complete audit trail for a specific document version.
 *
 * Traces all processing events from Outbox through Runs and Artifacts
 * to the specific document version, showing the full processing chain
 * with timestamps and detailed information for each step.
 *
 * Args:
 ...
 */
export const getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGet = <ThrowOnError extends boolean = false>(options: Options<GetVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetResponses, GetVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetErrors, ThrowOnError>({
        responseTransformer: getVersionAuditTrailDocumentsDocIdVersionsVersionIdAuditTrailGetResponseTransformer,
        responseType: 'json',
